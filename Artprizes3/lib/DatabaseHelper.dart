...
class DatabaseHelper {
  ...
  void createGennyTable(Database db, version) async {
    ...
    LoginToken.createTable(db, version);
    ArtPrize.createTable(db, version);
    Advertisment.createTable(db, version);
